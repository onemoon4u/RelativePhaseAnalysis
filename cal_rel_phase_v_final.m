...
function [rel_phase_w, rel_phase_t, rel_phase, magni, R_theta, T_theta, m_theta] = cal_rel_phase_v_final(H) 
...
%         end
        ...
        T_theta_ch =  T_theta* ones(1,ch) ; % Prepare global angle THETA for calculation
